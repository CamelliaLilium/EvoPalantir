...
| `rag_design/docs/references/` | **第三方调研**（须 **基线 commit** + 模板；见目录内 `README.md`） |
| `rag_design/docs/agentself-evolution.md` | 校正记忆 **补充调研条目**（与宪章互链） |
| `rag_design/docs/plans/2026-03-28-调研与设计-校正记忆与经验库.md` | **校正记忆引擎宪章**（模块/机制/交互/规则） |
